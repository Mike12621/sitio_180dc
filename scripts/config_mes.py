...
MARZO = {
    ...
    "egresos": [
        ...
        {
            "titulo": "Polos institucionales (lote 2)",
            "monto": 120.0,
            "fecha": "18/03/2026",
            "para_que": "Segundo lote de polos para cubrir la demanda de miembros nuevos.",
            "beneficio": "Inventario para miembros activos (reutilizable).",
            "comprobante": "Plin a proveedor de polos.",
            "categoria_ui": "Inversión — Polos",
            "es_inversion": True,
            "icono": "👕",
